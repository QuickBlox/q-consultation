import { ListUserParams, QBAppointment, QBSession, QBUser } from '@qc/quickblox'
...
export function createGuestClient(
  userName: string,
  then?: Types.QBCreateGuestUserRequestAction['payload']['then'],
): Types.QBCreateGuestUserRequestAction {
  return {
