...
import { BIRTHDATE_FORMAT } from '@qc/template/dateFormat'
...
export default function ProfileScreen() {
  const {
    ...
    forms: { profileForm },
    store: { error, myAccount, myAvatar },
          ...
          <div className="form-field-row">
            ...
            >
              <DateInputField
                ...
                valueFormat={BIRTHDATE_FORMAT}
                placeholder={t('DateFormat')}
                onDayChange={(day, inputValue) => {
                  profileForm.setFieldValue('birthdate', day || inputValue)
                }}
                inputProps={{
                  id: 'birthdate',
                  name: 'birthdate',
