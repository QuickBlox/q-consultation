...
export const QB_START_CALL_REQUEST = 'QB_START_CALL_REQUEST'
export const QB_START_CALL_SUCCESS = 'QB_START_CALL_SUCCESS'
export const QB_START_CALL_FAILURE = 'QB_START_CALL_FAILURE'
...
export interface QBStartCallRequestAction extends Action {
  type: typeof QB_START_CALL_REQUEST
  payload: {
    callType: 1 | 2
...
export interface QBStartCallSuccessAction extends Action {
  type: typeof QB_START_CALL_SUCCESS
  payload: {
...
export interface QBStartCallFailureAction extends Action {
  type: typeof QB_START_CALL_FAILURE
  error: string
}
...
export type QBWebRTCAction =
  | QBStartCallRequestAction
  | QBStartCallSuccessAction
  | QBStartCallFailureAction
